...
function displayPics(){
  ...
  // The reason that the console log threw an error is because the rando variable is scoped to the while loop. Since the console log is outside of that while loop, it doesn't have access to the rando variable.
  console.log(viewed);
