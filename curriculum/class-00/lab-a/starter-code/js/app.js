...
function displayPics(){
  ...
  // Let doesnot allow you to reassign to a variable where as var allows to assign it to the declared variable.In this scenario Math.Random is being assigned to rando so it has to be declared as var.
  //Arrays should not be const as they are changing as well as any variable that is changing values such as incrementing values inside a for loop
  console.log(viewed);
...
displayPics();
>>>>>>> ed3777907e936e9a6fc4a9de8aabd88b031b5709
