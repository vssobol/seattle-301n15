...
[EventBrite API Docs](https://www.eventbrite.com/platform/api) - For authentication, make sure to use the personal OAuth token flow. Don't use the App OAuth Flow. 
